...
var RefContext = function () {
  ...
  _createClass(RefContext, [{
    ...
    value: function resolve(context) {
      ...
      var contextDirectory = context.settings && context.settings["jsonschema"] && context.settings["jsonschema"]["contextDirectory"];
      if (!contextDirectory) {
        contextDirectory = ["."];
      }
      ...
      try {
        for (var _iterator2 = contextDirectory[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
